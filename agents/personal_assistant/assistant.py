...
def invoke_personal_assistant(user_message: str, conversation_history: str, context: Optional[Dict[str, Any]] = None, user_id: str = None, user_name: str = "User") -> Dict[str, Any]:
    """
    ...
    llm_response = gpt_oss_120b_digital_ocean.invoke(formatted_prompt)
