...
class PersonalAssistantService:
    """Service for handling personal assistant analysis requests."""
    ...
    def _ensure_orchestrator(self):
        """Ensure orchestrator is available, retry init if needed."""
    ...
    async def run_analysis(
        ...
        """Run analysis using the orchestrator graph."""
        ...
        try:
            ...
            orchestrator_input = {
                "user_id": str(metadata.get("user_id", "3")),
