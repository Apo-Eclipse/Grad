...
from personal_assistant_api.assistants.conversations import router as conversations_router
...
from personal_assistant_api.transaction_maker.api import router as transaction_maker_router
...
from personal_assistant_api.database.conversations import router as db_conversations_router
...
api.add_router("personal_assistant/conversations/", conversations_router, tags=["Conversations (Manual)"])
...
api.add_router("personal_assistant/transaction/", transaction_maker_router, tags=["Transaction Maker"])

# Database Endpoints (CRUD)
api.add_router("database/transactions/", transactions_router, tags=["Database - Transactions"])
...
api.add_router("database/conversations/", db_conversations_router, tags=["Database - Conversations"])
